/**
 * @file ebpf_kfunc.h
 * @brief kfuncs for eBPF programs
 */
 ...
 *	contains no nodes, returns NULL.
 */
extern struct bpf_rb_node *bpf_rbtree_next(struct bpf_rb_root *root, struct bpf_rb_node *node) __ksym;
...
/* Convenience macro to wrap over bpf_rbtree_search_impl */
#define bpf_rbtree_search(head, node, bpf_cb) bpf_rbtree_search_impl(head, node, bpf_cb, NULL, 0)

extern struct bpf_rb_node *bpf_rbtree_search_less_impl(struct bpf_rb_root *root, struct bpf_rb_node *node,
                                                       bool(less)(struct bpf_rb_node *a, const struct bpf_rb_node *b),
                                                       void *meta__ign, __u64 off) __ksym;

/* Convenience macro to wrap over bpf_rbtree_search_less_impl */
#define bpf_rbtree_search_less(head, node, same) bpf_rbtree_search_less_impl(head, node, same, NULL, 0)

extern struct bpf_rb_node *bpf_rbtree_lower_bound_impl(struct bpf_rb_root *root, struct bpf_rb_node *node,
                                                       bool(less)(struct bpf_rb_node *a, const struct bpf_rb_node *b),
                                                       void *meta__ign, __u64 off) __ksym;

/* Convenience macro to wrap over bpf_rbtree_lower_bound */
#define bpf_rbtree_lower_bound(head, node, less) bpf_rbtree_lower_bound_impl(head, node, less, NULL, 0)