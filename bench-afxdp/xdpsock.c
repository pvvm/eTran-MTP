...
static struct ether_addr opt_txsmac = {{0x9c, 0xdc, 0x71, 0x5d, 0x21, 0xc1}};
static struct ether_addr opt_txdmac = {{0x9c, 0xdc, 0x71, 0x4b, 0xa3, 0x71}};
